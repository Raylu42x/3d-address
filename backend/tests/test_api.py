...
"""test_api.py — exercise the REST API via FastAPI's TestClient (no server needed)."""
...
tp = c.post("/v1/decode", json={"address":"-".join(parts)}).json()
